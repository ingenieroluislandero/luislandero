(function (d, w, WOW) {
	...
	var stickyElements = d.querySelectorAll('.sticky'),
		arrowDown = d.querySelectorAll('.luislandero p')[2],
	...
	w.onload = function () {
		...
		for (var n = 0; n < links.length; n++) {
			links[n].addEventListener('click', function (e) {
				...
				} else if ( e.target.id == 'luislandero-btn' || e.target.classList.contains('fa-home') || e.target.textContent == 'luislandero' ) {
...
var _gaq = _gaq || [];
	...
	_gaq.push(['_setDomainName', 'luislandero.com']);
